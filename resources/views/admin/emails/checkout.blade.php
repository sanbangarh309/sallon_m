@php($msg_center = 'We have succesfully received your application for Service provider. Our sales team will shortly review your profile and contact you back within 24 hours.')
<html><head>
...
<tr>
            ...
            <div style="width:100%;">
              ...
              <div style="width: 100%; padding: 80px 0px; position:relative;">
                <h2 style="margin: 0 auto !important;max-width: 90%;font-weight:400;letter-spacing:2px; text-transform:uppercase; color:#000;">Account register Successfully.</h2>
              </div>
            </div>
          </td>
                </tr>
...
<p style="color: #eee; font-style:italic;">{!!$msg_center!!}</p>
    ...
    <tr style="margin:0; padding:0;">
        <td class="container" style="width:100%;background:#000 url('.get_stylesheet_directory_uri().'/images/footer-bg.jpg); background-size: cover; background-position:center center; padding:55px 35px 30px;" border="0" >
        ...
        <div style="float:right;margin-right:6%;">
          <div class="social-list" style="margin:0; padding:0;">
           <a style="margin-right:5px;" href="https://twitter.com/MASK_APP"><img src="{{ San_Help::san_Asset('images/t1.png') }}" alt=""></a>
            <a style="margin-right:5px;" href="https://www.youtube.com/channel/UCAlGTOmoO9ZigEQs_yTtJWQ"><img src="'.get_stylesheet_directory_uri().'/images/utube.png" alt=""></a>
