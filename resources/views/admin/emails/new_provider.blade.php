...
<tr>
            ...
            <div style="width:100%;">
              ...
              <div style="width: 100%; padding: 80px 0px; position:relative;">
                <h2 style="margin: 0 auto !important;max-width: 90%;font-weight:400;letter-spacing:2px; text-transform:uppercase; color:#000;">New Application Recieved.</h2>
              </div>
            </div>
          </td>
                </tr>
            ...
            <div class="inner-box" style="border: solid 1px #ccc;padding: 5%;background:url({{ San_Help::san_Asset('images/sml-icon.png') }}); background-repeat:no-repeat; background-position:right bottom;">
              ...
              <p style="color: #eee; font-style:italic;">New Service provider {!!$data->name!!} Registered Successfully. Please view the profile in admin for final approval.</p>
