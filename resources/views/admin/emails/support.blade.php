...
<tr>
            ...
            <div style="width:100%;">
              ...
              <div style="width: 100%; padding: 80px 0px; position:relative;">
                <h2 style="margin: 0 auto !important;max-width: 90%;font-weight:400;letter-spacing:2px; text-transform:uppercase; color:#000;">{!!$data->subject!!}</h2>
              </div>
            </div>
          </td>
            </tr>
            ...
            <div class="inner-box" style="border: solid 1px #ccc;padding: 5%;background:url({{ San_Help::san_Asset('images/sml-icon.png') }}); background-repeat:no-repeat; background-position:right bottom;">
              <h4 style="color: #eee;">Hi, Admin</h4>
              <p style="color: #eee; font-style:italic;">{!!$data->message!!}</p>
